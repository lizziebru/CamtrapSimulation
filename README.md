...
### **Data** (used in model parameterization)
...
## **Simulation data & plots on OneDrive**
___
...
All code and the data from Regent's Park and Panama used for model parameterization can be found in my CamtrapSimulation repository forked from Marcus' original one: https://github.com/lizziebru/CamtrapSimulation.
