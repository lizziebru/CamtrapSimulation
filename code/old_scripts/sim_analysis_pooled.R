...
# --> BUT: don't pool together results from different simulations bc it's not controlled enough otherwise - stick to just the same speed and parameters when combining stuff