...
# generate path
path <- pathgen(n=n, kTurn=kTurn, kCor=kCor, pTurn=pTurn, Mb=Mb, speedCor=speedCor, xlim=xlim)

metadata <- list(datetime=date, iter=iter, Mb=Mb, xlim=xlim, step_no=n, pTurn=pTurn, speedCor=speedCor, kTurn=kTurn, kCor=kCor, wrap=wrapped)
