...
seq_dat <- function(path, species, x, y, r, th, plot_path = TRUE, twoCTs = FALSE){
  # path <- path
  if (twoCTs == FALSE){
  ...
  df <- data.frame(realised = realised_spds, # realised speeds # put that into a list - look at stuff from HPC week
