...
# read in position data (one row = one position)
india_pos_data <- read.csv('data/india_pos_data.csv')


devtools::source_url("https://raw.githubusercontent.com/MarcusRowcliffe/CTtracking/master/CTtracking.r")


# format it with one row per sequence
india_mov_data <- seq.summary(india_pos_data)
